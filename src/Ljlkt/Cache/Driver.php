...
abstract class Driver
{
     ...
     * @var array
     */
    protected static $serialize = ['serialize', 'unserialize', 'ljlkt_serialize:', 16];
...
//                }
     ...
     * @return $this
     */
    public static function registerSerialize($serialize, $unserialize, $prefix = 'ljlkt_serialize:')
    {
